...
const APP_ASSETS = [
  "./", APP_SHELL_URL, "./pages/dashboard.html", "./pages/orcamentos.html", "./pages/estoque.html", "./pages/agenda.html", "./pages/pipeline.html", "./pages/relatorios.html", "./pages/backup.html", "./pages/configuracoes.html",
  "./assets/css/base.css", "./assets/css/tokens.css", "./assets/css/layout.css", "./assets/css/components.css", "./assets/css/pro-ui.css", "./assets/css/pro-polish.css", "./assets/css/app-refinements.css", "./assets/css/dashboard.css", "./assets/css/orcamentos.css", "./assets/css/estoque.css", "./assets/css/agenda.css", "./assets/css/pipeline.css", "./assets/css/relatorios.css", "./assets/css/backup.css", "./assets/css/configuracoes.css", "./assets/css/studio-workflow.css",
  "./assets/favicon/favicon.svg", "./img/mishiro-logo-claro.jpg", "./img/mishiro-logo-escuro.jpg", "./img/mishiro-simbolo-claro.jpg", "./img/mishiro-simbolo-escuro.jpg.jpg",
  ...
  "./src/pages/dashboard.js", "./src/pages/orcamentos.js", "./src/pages/orcamentos-workflow.js", "./src/pages/orcamentos-export.js", "./src/pages/estoque.js", "./src/pages/agenda.js", "./src/pages/pipeline.js", "./src/pages/relatorios.js", "./src/pages/backup.js", "./src/pages/configuracoes.js",
  "./src/services/estoque-service.js", "./src/services/orcamentos-service.js", "./src/services/agenda-service.js", "./src/services/backup-service.js", "./src/models/banco-local.js", "./src/models/esquema-banco.js", "./src/mvc/modelos/esquema-banco.js", "./src/mvc/modelos/banco-local.js", "./src/mvc/modelos/backup-local.js", "./src/mvc/servicos/servico-estoque.js", "./src/mvc/servicos/servico-orcamentos.js", "./src/mvc/servicos/servico-agendamentos.js", "./manifest.webmanifest", "./icons/icon.svg"
];
